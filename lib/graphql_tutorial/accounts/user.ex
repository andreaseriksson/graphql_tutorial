defmodule GraphqlTutorial.Accounts.User do
  use Ecto.Schema
  ...
  schema "users" do
    ...
    field :avatar, GraphqlTutorial.AvatarUploader.Type
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, GraphqlTutorial.Repo)
  ...
  """
  def valid_password?(%GraphqlTutorial.Accounts.User{hashed_password: hashed_password}, password)
