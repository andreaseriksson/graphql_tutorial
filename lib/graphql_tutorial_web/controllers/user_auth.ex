defmodule GraphqlTutorialWeb.UserAuth do
  import Plug.Conn
  ...
  def logout_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      GraphqlTutorialWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  def put_session_layout(conn, _opts) do
    conn
    |> put_layout({GraphqlTutorialWeb.LayoutView, :session})
  end
end
