defmodule GraphqlTutorialWeb.UserAuthTest do
  use GraphqlTutorialWeb.ConnCase, async: true

  alias GraphqlTutorial.Accounts
  alias GraphqlTutorialWeb.UserAuth
  import GraphqlTutorial.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, GraphqlTutorialWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      GraphqlTutorialWeb.Endpoint.subscribe(live_socket_id)
